...
void SceneController::OnMouseMove(WPARAM wParam, LPARAM lParam) {
    if (m_isTrapped) {
...
void SceneController::OnLButtonDown(WPARAM wParam, LPARAM lParam) {
    m_isTrapped = true;
    m_trapLast.x = m_trapStart.x = GET_X_LPARAM(lParam);
    m_trapLast.y = m_trapStart.y = GET_Y_LPARAM(lParam);
}

void SceneController::OnLButtonUp(WPARAM wParam, LPARAM lParam)
{
    m_isTrapped = false;
    m_trapLast.x = GET_X_LPARAM(lParam);
    m_trapLast.y = GET_Y_LPARAM(lParam);
